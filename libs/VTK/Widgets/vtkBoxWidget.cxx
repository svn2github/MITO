/*=========================================================================
  ...
  Module modified by: Luigi Gallo (ICAR-CNR), Aniello Minutolo (ICAR-CNR)
...
// added to declare vtkWii... identifiers
#include "vtkInteractorStyle.h"

vtkCxxRevisionMacro(vtkBoxWidget, "$Revision: 1.2 $");
...
void vtkBoxWidget::onWiiMotion() 
{   		
	// Settando questo flag l'evento vtk non sarà propagato ulteriormente.
	this->EventCallbackCommand->SetAbortFlag(1);	
}

void vtkBoxWidget::onWiiADown()
{
	// Settando questo flag l'evento vtk non sarà propagato ulteriormente.
	this->EventCallbackCommand->SetAbortFlag(1);	
}

void vtkBoxWidget::onWiiAUp() 
{
	// Settando questo flag l'evento vtk non sarà propagato ulteriormente.
	this->EventCallbackCommand->SetAbortFlag(1);	
}

void vtkBoxWidget::onWiiBDown() 
{
	// Settando questo flag l'evento vtk non sarà propagato ulteriormente.
	this->EventCallbackCommand->SetAbortFlag(1);	
}

void vtkBoxWidget::onWiiBUp() 
{
	// Settando questo flag l'evento vtk non sarà propagato ulteriormente.
	this->EventCallbackCommand->SetAbortFlag(1);	
}

void vtkBoxWidget::onWiiMinusDown() 
{
	this->State = vtkBoxWidget::Moving;		
	this->HighlightFace(this->HighlightHandle(NULL));
...
void vtkBoxWidget::onWiiMinusUp() 
{
	// Settando questo flag l'evento vtk non sarà propagato ulteriormente.
	this->EventCallbackCommand->SetAbortFlag(1);	
}

void vtkBoxWidget::onWiiHomeDown() 
{  
...
void vtkBoxWidget::onWiiHomeUp() 
{
	// Settando questo flag l'evento vtk non sarà propagato ulteriormente.
	this->EventCallbackCommand->SetAbortFlag(1);	
}

void vtkBoxWidget::onWiiPlusDown() 
{	  
	this->State = vtkBoxWidget::Moving;		
...
void vtkBoxWidget::onWiiPlusUp() 
{
	// Settando questo flag l'evento vtk non sarà propagato ulteriormente.
	this->EventCallbackCommand->SetAbortFlag(1);	
}

void vtkBoxWidget::onWiiOneDown() 
{	
	// Settando questo flag l'evento vtk non sarà propagato ulteriormente.
	this->EventCallbackCommand->SetAbortFlag(1);	
}

void vtkBoxWidget::onWiiOneUp() 
{
	// Settando questo flag l'evento vtk non sarà propagato ulteriormente.
	this->EventCallbackCommand->SetAbortFlag(1);	
}

void vtkBoxWidget::onWiiTwoDown() 
{
	// Settando questo flag l'evento vtk non sarà propagato ulteriormente.
	this->EventCallbackCommand->SetAbortFlag(1);	
}

void vtkBoxWidget::onWiiTwoUp() 
{
	// Settando questo flag l'evento vtk non sarà propagato ulteriormente.
	this->EventCallbackCommand->SetAbortFlag(1);	
}

void vtkBoxWidget::onWiiCrossDown() 
{		
	// Process the motion
	if ( this->State == vtkBoxWidget::Moving )
    {		
...
void vtkBoxWidget::onWiiCrossUp() 
{ 
	// Settando questo flag l'evento vtk non sarà propagato ulteriormente.
	this->EventCallbackCommand->SetAbortFlag(1);	
