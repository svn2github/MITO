...
inline void wxAdjustBrightness(unsigned char& r, unsigned char& g, unsigned char& b, char n)
{
...
inline void wxAdjustToColour(unsigned char& r, unsigned char& g, unsigned char& b, const wxColour& c)
{
