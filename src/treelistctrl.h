...
public:
    wxTreeListColumnInfo (const wxString &text = wxEmptyString,
        ...
        m_shown = shown;
        m_edit = edit;
		m_eSortStatus = wxHDR_SORT_ICON_NONE;
    }
    ...
    wxTreeListColumnInfo (const wxTreeListColumnInfo& other) {
        ...
        m_edit = other.m_edit;
		m_eSortStatus = other.m_eSortStatus;
    }
	...
	wxHeaderSortIconType GetSortStatus() {return m_eSortStatus;}
	void SetSortStatus(wxHeaderSortIconType newStatus) {m_eSortStatus = newStatus;}
...
private:
    ...
    bool m_shown;
    bool m_edit;
	wxHeaderSortIconType	m_eSortStatus;	// Mod. Alessio Placitelli per supporto sorting da colonna
};
...
public:
    ...
    // --------
    wxTreeListCtrl()
        : m_header_win(0), m_main_win(0), m_headerHeight(0), m_iColumnToSort(-1)
    {}
	...
	void DoAlternateRowColors(wxColor c1 = wxColor(255,255,255), wxColor c2 = wxColor(218,254,253));
...
private:
    int m_headerHeight;
	int	m_iColumnToSort;		// Modifica Alessio Placitelli
